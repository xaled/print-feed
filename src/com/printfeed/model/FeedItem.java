...
public class FeedItem implements Serializable {
	...
	// Constructor with ID
	public FeedItem(int id, String title, String link, String desc,
			int sourceID, int seen, String date) {
	...
	public FeedItem(String title, String link, String desc, int sourceID,
			int seen, String date) {
